...
def photos():
    ...
    with col1:
        ...
        st.image("/Users/julien/Desktop/stream2/Leonardo_Phoenix_A_gritty_highcontrast_image_of_a_lone_middle_3.jpg")

    with col2:
        st.markdown("<h3 style='text-align: center; color: white;'>Fingy à la plage</h3>", unsafe_allow_html=True)
        st.image("/Users/julien/Desktop/stream2/Leonardo_Phoenix_A_solitary_hand_with_a_prominent_middle_finge_0.jpg")

    with col3:
        st.markdown("<h3 style='text-align: center; color: white;'>Fingy à la montagne</h3>", unsafe_allow_html=True)
        st.image("/Users/julien/Desktop/stream2/Leonardo_Phoenix_updatedpromptA_dramatic_highcontrast_image_fe_3.jpg")